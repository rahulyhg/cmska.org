...
INSERT INTO "site"."files" ("md5", "load_time", "orig_name", "size", "user_id", "post_id", "mime", "encoded", "keyring") VALUES ('79fa8a5aab736a9e895471a54de08b18', '2018-09-19 23:21:31', 'vejvlety_v_stenografii.pdf', 123480, 1, 13, 'application/pdf', 1, 'vmhuidn-56@98lcg10=fw$xp3j{2b+z*&as}orye7^4tkkt4^7eyro}sa&*z+b2{j3px$wf=01gcl89@65-ndiuhmv');
...
INSERT INTO "site"."users" ("id", "login", "password", "email", "last_ip", "token", "group_id") VALUES (1, 'admin', '5729c5f66821340f23f4559243a8a2eb', 'admin@cmska.org', '185.103.42.10', '242757013206b715e2167ffbb32e75f0', 1);
