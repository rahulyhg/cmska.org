...
INSERT INTO "site"."categories" ("id", "altname", "name", "parent_id", "ptree", "position", "level") VALUES (4, 'maincateg', 'Розділ 1', 0, '0', 0, 0);
INSERT INTO "site"."categories" ("id", "altname", "name", "parent_id", "ptree", "position", "level") VALUES (1, 'categ1', 'Категорія 1', 4, '0-4', 0, 1);
INSERT INTO "site"."categories" ("id", "altname", "name", "parent_id", "ptree", "position", "level") VALUES (2, 'categ1_1', 'Категорія 1-1', 1, '0-4-1', 0, 2);
INSERT INTO "site"."categories" ("id", "altname", "name", "parent_id", "ptree", "position", "level") VALUES (3, 'categ1_1_1', 'Категорія 1-1-1', 2, '0-4-1-2', 0, 3);
...
SELECT pg_catalog.setval('"site"."categories_id_seq"', 4, true);
...
SELECT pg_catalog.setval('"site"."posts_id_seq"', 3, true);
...
INSERT INTO "site"."users" ("id", "login", "password", "email", "last_ip", "token", "group_id") VALUES (1, 'admin', '6b5d3fde336ba463eb445a2d5bcfc30e', 'admin@cmska.org', '217.115.103.1', 'c74c16be735c3b089187e19cd193f9be', 1);
...
CREATE TRIGGER "before_ins_upd_posts" BEFORE INSERT OR UPDATE OF "title", "descr", "full_post", "svector", "keywords" ON "site"."posts" FOR EACH ROW EXECUTE PROCEDURE "site"."before_ins_upd_posts"();
